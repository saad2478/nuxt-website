...
export default {
  head() {
    return {
      title: 'About Us | IoT Expert',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Learn more about our company, our mission, and our team. We are committed to delivering the best IoT solutions for your business.'
        }
      ]
    };
  }
